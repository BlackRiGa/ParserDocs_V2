...
public class DatabaseTwoConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "movies.spring.data.neo4j.repositories.repositoryForPostgre";
    public static final String ENTITY_PACKAGE = "movies.spring.data.neo4j.models.PostgreModel";
